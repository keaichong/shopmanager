<template>
  <el-card class="box-card">
    <!-- 面包屑 -->
    <bread-crumb title1="商品管理" title2="商品分类"></bread-crumb>
    <!-- tianjia  anniu -->
    <el-button class="btn" type="success" @click="addGoodsCate()">添加分类</el-button>
...
export default {
  // 局部组件第一个是标签名字 el-tree-grid 可以用短横线连接s
  components: {
  ...
  methods: {
    ...
    // 添加分类- 显示对话框
    async addGoodsCate() {
      // 只需要获取两级分类的数据  用户选取了一二级分类就可以添加第三级分类
